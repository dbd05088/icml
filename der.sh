...
# CIL CONFIG
NOTE="der_mem_50000_iter0.25" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="der"
...
do
    CUDA_VISIBLE_DEVICES=5 nohup python main.py --mode $MODE --n_worker 3 \
    --dataset $DATASET  \
